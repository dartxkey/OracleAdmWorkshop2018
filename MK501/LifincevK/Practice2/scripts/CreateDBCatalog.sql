...
set echo on
spool /home/oracle/app/oracle/admin/Lifintsev/scripts/CreateDBCatalog.log append
...
connect "SYSTEM"/"&&systemPassword"
set echo on
spool /home/oracle/app/oracle/admin/Lifintsev/scripts/sqlPlusHelp.log append
